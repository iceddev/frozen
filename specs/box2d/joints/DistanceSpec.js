...
], function(Box, Rectangle, Distance){

  'use strict';

  var rectJSON = {id: 'a', halfHeight: 30, halfWidth: 60, staticBody: false, x: 30, y: 30};
  var rectJSON2 = {id: 'b', halfHeight: 60, halfWidth: 30, staticBody: false, x: 120, y: 120};

  describe('Distance Joint', function(){
    ...
    it('check defaults body points', function(){
      ...
      expect(joint.bodyPoint2).toBeNull();
    });

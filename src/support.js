(function(global, define){
  ...
  define(function(require){
    ...
    // shim WebAudio
    require('./shims/AudioContext');

    var on = require('on');

    var support = {
      'html5-audio': !!global.Audio,
      'web-audio': !!global.AudioContext,
      'shitty-sound': true
    };

    // Detect autoplay function from https://gist.github.com/mrcoles/5537536
    (function(){

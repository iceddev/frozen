...
if(has('HTML5Audio') && !has('shittySound')){
  describe('HTML5Audio', function(){
    var sound;
    var filename = has('ie') ? 'test/fixtures/yipee.mp3' : 'test/fixtures/yipee.wav';
    ...
    describe('HTML5Audio.load()', function(){
      ...
      it('should create a new instance of Audio as audio', function(){
        var audio = new Audio();
        sound.load(filename);
        expect(sound.audio).toExist();
        expect(sound.audio instanceof Audio).toBe(true);
        expect(sound.audio).toNotBe(audio);
      });
      ...
      it.skip('should add an extension if one is not specified on filename passed in', function(){
      ...
      it.skip('should try another extension if one is not specified on filename passed in and the first one fails', function(){
      ...
      it.skip('should set complete to true if all extensions fail', function(){
        spyOn(sound, '_chooseFormat').andCallThrough();
      ...
      it.skip('should mark the sound as complete when done loading data', function(){
        runs(function(){
          sound.load(filename);
        });
    ...
    describe.skip('HTML5Audio.loop()', function(){
      var audio;
    ...
    describe.skip('HTML5Audio.play()', function(){
      var audio;
